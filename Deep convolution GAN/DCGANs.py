...
class Generator(nn.Module):
    def __init__(self, z_dim , batch_size=batch_size):
        ...
        self.block1 = self.gen_block( z_dim ,output_channels = 128 ,kernel_size= 3, stride=1 )
        self.block2 = self.gen_block( 128 ,output_channels = 64 ,kernel_size= 3, stride=1 )
        self.block3 = self.gen_block(64 ,output_channels = 32 ,kernel_size= 3, stride=1 )
        self.block4 = self.gen_block(32 ,output_channels = 16 ,kernel_size= 3, stride=1 )
        self.block5 = self.gen_block( 16 ,output_channels = 8 ,kernel_size= 3, stride=1 )
        self.block6 = self.gen_block(8 ,output_channels = 1 ,kernel_size= 3, stride=1, final_layer=True)
...
def get_noise(batch_size = batch_size , z_dim = 64, device = 'cpu'):
...
def disc_loss(disc,gen,real_data,criterion):
    ...
    noise = get_noise( batch_size , z_dim,device='cpu')
